import{f as e,r as t,u as n}from"./i18n-CBV1HzVj.js";import{i as r}from"./presenter-iVT0AIJi.js";function i(i){let a=(i.status&&typeof i.status==`object`?i.status.securityAudit:null)?.summary??null,o=a?.critical??0,s=a?.warn??0,c=a?.info??0,l=o>0?`danger`:s>0?`warn`:`success`,u=o>0?`${o} critical`:s>0?`${s} warnings`:`No critical issues`;return e`
    <section class="grid">
      <div class="card">
...
//# sourceMappingURL=debug-CTtsassX.js.map